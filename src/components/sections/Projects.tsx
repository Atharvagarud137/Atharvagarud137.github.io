...
const styles: Record<string, React.CSSProperties> = {
  ...
  link: { fontFamily: 'var(--mono)', fontSize: '0.65rem', letterSpacing: '0.1em', textTransform: 'uppercase' as const, color: 'rgba(245,242,235,0.4)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' },
};
