      ...
      <div style={styles.grid}>
        ...
        >
          <p style={styles.para}>
            ...
            Technology from PCCOE Pune, I combine engineering fundamentals with deep fintech domain
            knowledge.
          </p>
          <p style={styles.para}>
            My core focus is <strong>shift-left testing</strong> — embedding quality early in the
            development cycle to prevent defects rather than just detect them. I architect
            Python-based automation pipelines, maintain CI/CD-integrated regression suites, and
            have a track record of catching critical production defects before they reach live
            payment processing.
          </p>
          <p style={styles.para}>
            Beyond my day job, I build ML-powered validation tools and explore the intersection of
            AI and software quality — applying imbalanced dataset handling and model evaluation
            pipelines to fraud detection and deepfake identification.
          </p>
        </motion.div>

        <div style={styles.statsGrid}>
          {stats.map((stat, i) => (
            <StatCard key={stat.num + stat.label} stat={stat} index={i} />
          ))}
        </div>
      </div>
    </section>
